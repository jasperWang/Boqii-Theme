...
public class FindPeopleActivity extends ActivityGroup implements OnClickListener{
	...
	public void initTabHost(){
		...
		Intent intent1 = new Intent().setClass(FindPeopleActivity.this,FansListActivity.class).putExtra("_type", 0).putExtra("_userId", userId);
		Intent intent2 = new Intent().setClass(FindPeopleActivity.this,FansListActivity.class).putExtra("_type", 1).putExtra("_userId", userId);
		Intent intent3 =new Intent().setClass(FindPeopleActivity.this,FansListActivity.class).putExtra("_type", 2).putExtra("_userId", userId);
