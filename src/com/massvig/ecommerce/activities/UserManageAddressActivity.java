...
public class UserManageAddressActivity extends BaseActivity implements LoadListener,
		OnClickListener {
	...
	private void initView() {
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				startActivityForResult(new Intent(UserManageAddressActivity.this, AddressDetailActivity.class).putExtra("address", address.toString()), MODIFY);
			}});
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.back:
			UserManageAddressActivity.this.finish();
			break;
		case R.id.finish:
